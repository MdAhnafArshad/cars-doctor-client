...
const Banner = () => {
    ...
    const slider = <div className="absolute  flex items-center justify-start h-full  bottom-0 text bg-gradient-to-r from-[#151515] to-[rgba(21, 21, 21, 0)]">
        <div className='text-3xl  text-white space-y-7  w-1/3 p-5 m-5'>
            ...
            <div>
                <button className="btn btn-outline btn-primary m-5">Discover More</button>
